...
<h1 className='mb-3 fs-2'>Free and open market education</h1>
    ...
    <a href="" className='mx-5 mb-4' style={{textDecoration:"none"}}>Varsity  <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    <p className='mb-2 mt-5'>TradingQ&A, the most active trading and investment community in India for all your market related queries.</p>
